...
Este projeto é um estudo baseado em dados viários para previsão de mortes relacionadas à segurança viária e veicular no Brasil com o intuito de confeccionar um modelo de melhor ajuste para expressar a quantidade futura de mortes no trânsito, a fim de gerar um artigo científico para o Observatório Nacional de Segurança Viária (ONSV).
