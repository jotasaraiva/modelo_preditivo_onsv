...
Os estudo contempla técnicas de modelagem de análise de regressão e análise de séries temporais, cultivando diferentes modelos e os testando para avaliar a qualidade de das previsões, as taxas de acertos, a influência das variáveis consideradas e a capacidade de cada tipo de método em expressar o fenômeno real dos óbitos em trânsito, utilizando *frameworks* como [`tidymodels`](https://github.com/tidymodels/tidymodels) e [`forecast`](https://github.com/robjhyndman/forecast).
...
O conteúdo do artigo pode ser lido no site oficial do [ONSV](https://www.onsv.org.br/).
