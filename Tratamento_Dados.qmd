...
import_pop <- function(endereco) {
  ...
  # try(
  #   if(str_sub(endereco,24,27) == "2001"){
  #     return(
  #       read_excel(endereco) |>
  #         filter(!row_number() %in% seq(1,4)) |>
  #         select(last_col()) |>
  #         rename("pop" = starts_with(".")) |>
  #         mutate(
  #           total = sum(as.numeric(pop)),
  #           ano = str_sub(endereco,24,27) |>
  #             as.numeric()
  #         ) |>
  #         slice(1) |>
  ...
  #     )
  #   }
  #   else if(str_sub(endereco,24,27) == "2002"){
  #     return(
  #       read_excel(endereco) |>
  #         filter(!row_number() %in% seq(1,5)) |>
  #         select(last_col()) |>
  #         rename("pop" = starts_with(".")) |>
  #         mutate(
  #           total = as.numeric(pop[length(pop)]),
  #           ano = str_sub(endereco,24,27) |>
  #             as.numeric()
  #         ) |>
  #         slice(1) |>
  ...
  #     )
  #   }
  #   else if(str_sub(endereco,24,27) == "2003"){
  #     return(
  #       read_excel(endereco) |>
  #         filter(!row_number() %in% seq(1,4)) |>
  #         drop_na() |>
