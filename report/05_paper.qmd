...
-   PIB;
-   População;
-   Quantidade de sinistros em rodovias federais;
-   Quantidade de sinistros fatais em rodovias federais;
-   Feridos em sinistros ocorridos em rodovias federais;
-   Mortos em sinistros ocorridos em rodovias federais;
-   Quantidade de condutores habilitados.
...
O valor obtido da previsão implica uma leve queda de 7,4% no número de mortes Por outro lado, há a hipótese de que este é o efeito direto da pandemia e do processo de reintegração da população ao trânsito após o período de isolamento social e *lockdown*.
