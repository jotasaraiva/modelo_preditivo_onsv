...
A fim de melhor compreender o comportamento destas variáveis em uma resolução temporal maior, as seguintes visualização demonstram a variação cada atributo considerado conforme o tempo do período disponível para estudo:
