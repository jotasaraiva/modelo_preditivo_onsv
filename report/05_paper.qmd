...
Outra variável que deve ser analisada individualmente é o número de condutores, que possui uma alta correlação com a população e um comportamento crescente similar. Para verificar que o número de condutores possui um acréscimo homogêneo ao longo do período estudado, calcula-se os novos condutores por ano, como visto na figura, denotando como o ano de 2020 soferu de uma que brusca de novos indivíduos, possivelmente devido aos impactos da pandemia. Em comparação à população, os condutores oferecem melhores valores nas métricas de desempenho.
