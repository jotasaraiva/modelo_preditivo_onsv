...
A gravidade do número de mortes e a qualidade da predição podem ser transparecidos pelo cálculo das taxas de mortos por habitantes e por veículos, com o propósito de observar suas tendências. A @fig-mortes-hab explicita a crescente taxa de mortes no trânsito em função da população:
...
A taxa de mortes por veículos, como mostrada na @fig-mortes-veic, demonstra uma queda progressiva significativa, um possível indício do aumento desproporcional da frota de veículos em relação as mortes no trânsito:
