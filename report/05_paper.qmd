...
Desta forma, o próximo passo inclue a engenharia dos atributos para a otimização do modelo. O estudo inferencial mostra como diversas variáveis consideradas possuem alta colinearidade, devidamente atribuída as relações reais que um dado viário considerado têm com a ocorrência de outro. Por exemplo, a quantidade de mortes em sinistros de trânsito é diretamente dependente da quantidade de acidentes fatais, que por sua vez depende da quantidade de acidentes totais.
