...
A gravidade do número de mortes e a qualidade da predição podem ser transparecidos pelo cálculo das taxas de mortos por habitantes e por veículos, com o propósito de observar suas tendências. A @fig-hab explicita a crescente taxa de mortes no trânsito em função da população:
...
taxas_plot1 +
  geom_label(
    ...
    aes(x = ano,
        ...
        label = format(mortes_100mil_hab_pred, decimal.mark = ",", digits = 3)),
    color = "gray20",
    vjust = 0,
    nudge_y = 0.20
  )
...
A taxa de mortes por veículos, como mostrada na @fig-veic, demonstra uma queda progressiva significativa, um possível indício do aumento desproporcional da frota de veículos em relação as mortes no trânsito:
...
taxas_plot2 +
  geom_label(
    ...
    aes(x = ano,
        ...
        label = format(mortes_10mil_veic_pred, decimal.mark = ",", digits = 2)),
    color = "gray20",
    vjust = 0,
    nudge_y = 0.10
  )
