...
A gravidade das mortes e a qualidade da predição podem ser transparecidos pelo cálculo das taxas de mortos por quantidade de habitantes e de veículos, como o propósito de observar a tendência destas taxas. A @fig-mortes-hab explicita a crescente taxa de mortes trânsito em função da população:

```{r}
#| fig.cap: Mortes por 100.000 habitantes
#| echo: false
#| label: fig-mortes-hab
#| fig.width: 7
#| fig.height: 5
...
A taxa de mortes por veículos, como mostrada na @fig-mortes-veic, demonstra uma queda progressiva significativa, um possível indício do aumento desproporcional da frota de veículos em relação as mortes em trânsito:

```{r}
#| fig.cap: Mortes por 10.000 veículos
#| echo: false
#| label: fig-mortes-veic
#| fig.width: 7
#| fig.height: 5
